...
public class PasswordResetTokenConfiguration : IEntityTypeConfiguration<PasswordResetTokenPersistenceModel>
{
    public void Configure(EntityTypeBuilder<PasswordResetTokenPersistenceModel> builder)
    {
