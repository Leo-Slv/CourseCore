...
public class UnlistVideoUseCase
{
    private readonly IVideoRepository _videos;
    private readonly IUnitOfWork _unitOfWork;
    private readonly IAuditLogService _auditLogs;

    public UnlistVideoUseCase(IVideoRepository videos, IUnitOfWork unitOfWork, IAuditLogService auditLogs)
    {
        _videos = videos;
    ...
    public Task<VideoOutput> ExecuteAsync(Guid videoId, CancellationToken cancellationToken = default)
    {
        ...
        return _unitOfWork.ExecuteAsync(async () =>
        {
            ...
            await _auditLogs.RecordAsync(
                AuditLogActionNames.VideoUnlisted,
                "Video",
                video.Id,
